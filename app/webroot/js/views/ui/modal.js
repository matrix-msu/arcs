...
(function() {
  ...
  arcs.views.Modal = (function(_super) {
    ...
    Modal.prototype.initialize = function() {
      var $sel, name, options, _ref, _ref1;
      $('#modal').remove();
      ...
      for (name in _ref) {
        ...
        if (options.complete || options.multicomplete) {
          arcs.utils.autocomplete({
            ...
            source: (_ref1 = options.multicomplete) != null ? _ref1 : options.complete
          });
        }
      }
    ...
    Modal.prototype.bindButtons = function() {
      ...
      for (name in this.options.buttons) {
        _results.push(this.$("button#modal-" + name + "-button").click(function(e) {
          var callback, cb, context, options, valid, _ref, _ref1, _ref2;
          name = e.target.id.match(/modal-([\w-]+)-button/)[1];
          options = _this.options.buttons[name];
          if (_.isFunction(options)) {
            cb = options;
          } else {
            _ref2 = [(_ref = options.callback) != null ? _ref : (function() {}), (_ref1 = options.context) != null ? _ref1 : window], callback = _ref2[0], context = _ref2[1];
