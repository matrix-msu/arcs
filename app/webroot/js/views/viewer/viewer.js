...
(function() {
  ...
  arcs.views.Viewer = (function(_super) {
    ...
    Viewer.prototype.set = function(identifier, options) {
      var index, model, route, _ref, _ref1, _ref2;
      if (options == null) {
        options = {};
      }
      if (options.noSet) {
      ...
      route = "" + ((_ref1 = (_ref2 = arcs.collectionModel) != null ? _ref2.id : void 0) != null ? _ref1 : this.model.id) + "/" + (this.index + 1);
