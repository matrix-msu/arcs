...
(function() {
  ...
  arcs.views.Annotation = (function(_super) {
    ...
    Annotation.prototype._placePopover = function($el) {
      var best, choice, k, maxHeight, maxWidth, offsets, _ref, _ref1;
      ...
      _ref1 = ['right', offsets.right], choice = _ref1[0], best = _ref1[1];
      for (k in offsets) {
        if (offsets[k] > best) {
    ...
    Annotation.prototype.openAnnotator = function() {
      var _ref,
        _this = this;
      if ((_ref = this.annotator) != null ? _ref.isOpen() : void 0) {
        return;
      }
      ...
      annos = {
        annotations: this.collection.map(function(m) {
          ...
          if (rid = m.get('relation')) {
            m.set('relation', (((_ref = _this.search) != null ? _ref.results.get(rid) : void 0) || ((_ref1 = _this.collection.relations) != null ? _ref1.get(rid) : void 0)).toJSON());
          }
