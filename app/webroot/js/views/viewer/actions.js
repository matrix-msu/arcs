...
(function() {
  ...
  arcs.views.ViewerActions = (function(superClass) {
    extend(ViewerActions, superClass);
    ...
    ViewerActions.prototype.edit = function() {
      var field, fields, help, inputs, metadata, ref;
      inputs = {
        title: {
      ...
      for (field in fields) {
        help = fields[field];
        inputs[field] = {
          value: (ref = metadata.get(field)) != null ? ref : '',
          help: help
        };
      }
      return new arcs.views.Modal({
    ...
    ViewerActions.prototype["delete"] = function() {
      return arcs.confirm("Are you sure you want to delete this resource?", "<b>" + (this.viewer.model.get('title')) + "</b> will be permanently deleted.", (function(_this) {
        return function() {
    ...
    ViewerActions.prototype.deleteCollection = function() {
      return arcs.confirm("Are you sure you want to delete this collection?", ("<p>Collection <b>" + (this.viewer.collectionModel.get('title')) + "</b> will be ") + "deleted. <p><b>N.B.</b> Resources within the collection will not be " + "deleted. They may still be accessed from other collections to which they " + "belong.", (function(_this) {
        return function() {
          arcs.loader.show();
          return $.ajax({
    ...
    ViewerActions.prototype._checkZoom = function() {
      ...
      if (zoom === 2) {
        this.$('#zoom-in-btn').addClass('disabled');
      }
      if (zoom > 1) {
        this.$('#zoom-out-btn').removeClass('disabled');
      }
      if (zoom < 2) {
        return this.$('#zoom-in-btn').removeClass('disabled');
      }
    };
