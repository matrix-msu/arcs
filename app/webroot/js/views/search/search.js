...
(function() {
  var base, display, filteredFilters, filters, filtersApplied, selected, selectedCount, selectedMap, totalResults, unfilteredResults, waiting,
  ...
  arcs.views.search.Search = (function(superClass) {
    var adjustPage, createAllFilter, fillArray, noResults, pagination, search, setCreators, setExcavations, setFilters, setResources, setSeasons, setSites, showSelected;
    ...
    Search.prototype._render = function(results, append) {
      var $results, adjustFilters, filterResults, getCnt, template;
      if (append == null) {
        append = false;
      }
      ...
      adjustFilters = function() {
        ...
        return $('.filter').each(function() {
          ...
          if (ref = $(this).html(), indexOf.call(filters['creators'], ref) >= 0) {
            $('.filter').css('display', '');
          }
          if (ref1 = $(this).html(), indexOf.call(filters['excavations'], ref1) >= 0) {
            $('.filter').css('display', '');
          }
          if (ref2 = $(this).html(), indexOf.call(filters['seasons'], ref2) >= 0) {
            $('.filter').css('display', '');
          }
          if (ref3 = $(this).html(), indexOf.call(filters['sites'], ref3) >= 0) {
            $('.filter').css('display', '');
          }
          if (ref4 = $(this).html(), indexOf.call(filters['types'], ref4) >= 0) {
            return $('.filter').css('display', '');
          }
        });
      };
      filterResults = function() {
        var creator, excavationType, item, j, key, len, ref, ref1, ref2, ref3, ref4, seasonName, sites, type, val;
        totalResults = [];
        filters = {
          'creators': [],
          'excavations': [],
        ...
        for (key in unfilteredResults) {
          ...
          if ((ref = val['Excavation Name'], indexOf.call(filters['sites'], ref) < 0) && val['Excavation Name'] !== '') {
            filters['sites'].push(val['Excavation Name']);
          }
          if ((ref1 = val['Season Name'], indexOf.call(filters['seasons'], ref1) < 0) && val['Season Name'] !== '') {
            filters['seasons'].push(val['Season Name']);
          }
          if ((ref2 = val['Type'], indexOf.call(filters['types'], ref2) < 0) && val['Type'] !== '') {
            filters['types'].push(val['Type']);
          }
          if ((ref3 = val['Excavation Type'], indexOf.call(filters['excavations'], ref3) < 0) && val['Excavation Type'] !== '') {
            filters['excavations'].push(val['Excavation Type']);
          }
          ref4 = val["Creator"];
          for (j = 0, len = ref4.length; j < len; j++) {
            item = ref4[j];
            if (indexOf.call(filters['creators'], item) < 0) {
