...
(function() {
  ...
  if ((_ref = (_base = arcs.views).search) == null) {
    _base.search = {};
  }
  ...
  arcs.views.search.Actions = (function(_super) {
    ...
    Actions.prototype.editSelected = function() {
      var field, fields, help, inputs, metadata, result, _ref1,
        _this = this;
      if (!this.results.anySelected()) {
        return;
      }
      ...
      for (field in fields) {
        help = fields[field];
        inputs[field] = {
          value: (_ref1 = metadata.get(field)) != null ? _ref1 : '',
          help: help
        };
      }
      return new arcs.views.Modal({
    ...
    Actions.prototype.batchEditSelected = function() {
      var checked, field, help, inputs, results, types, value, values, _ref1,
        _this = this;
      ...
      _ref1 = arcs.config.metadata;
      for (field in _ref1) {
        help = _ref1[field];
        if (__indexOf.call(arcs.config.metadataSingular, field) >= 0) {
          continue;
        }
    ...
    Actions.prototype.collectionFromSelected = function(vals) {
      ...
      collection = new arcs.models.Collection({
        title: (_ref1 = vals.title) != null ? _ref1 : "Temporary Collection",
