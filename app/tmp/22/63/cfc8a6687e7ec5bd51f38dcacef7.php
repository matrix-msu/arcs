...
class __TwigTemplate_2263cfc8a6687e7ec5bd51f38dcacef7 extends Twig_Template
{
  ...
  ";
        ...
        if (isset($context["resource"])) { $_resource_ = $context["resource"]; } else { $_resource_ = null; }
        echo $this->getAttribute($_html_, "link", array(0 => $this->getAttribute($this->getAttribute($_resource_, "Resource"), "title"), 1 => ("/resource/" . $this->getAttribute($this->getAttribute($_resource_, "Resource"), "id")), 2 => array("class" => "title subtle")), "method");
        // line 3
        echo " 
  ...
  <div class=\"viewer-tabs tabbable\">
    ...
    <div class=\"tab-content\">
      <div class=\"tab-pane active\" id=\"information\">
        ...
        ";
        // line 83
        if (isset($context["memberships"])) { $_memberships_ = $context["memberships"]; } else { $_memberships_ = null; }
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($_memberships_);
        foreach ($context['_seq'] as $context["_key"] => $context["m"]) {
            ...
            if (isset($context["resource"])) { $_resource_ = $context["resource"]; } else { $_resource_ = null; }
            echo $this->getAttribute($_html_, "link", array(0 => $this->getAttribute($this->getAttribute($_m_, "Collection"), "title"), 1 => ((("/collection/" . $this->getAttribute($this->getAttribute($_m_, "Collection"), "id")) . "/") . $this->getAttribute($this->getAttribute($_resource_, "Resource"), "id"))), "method");
            // line 85
            echo "
          <br>
        ";
...
<script>
  arcs.resource = new arcs.models.Resource(";
        // line 119
        if (isset($context["resource"])) { $_resource_ = $context["resource"]; } else { $_resource_ = null; }
        echo twig_jsonencode_filter($_resource_);
        echo ");
...
";
    ...
    {
        return array (  187 => 119,  176 => 110,  169 => 108,  164 => 105,  161 => 104,  155 => 100,  151 => 98,  148 => 97,  137 => 88,  129 => 85,  123 => 84,  118 => 83,  78 => 45,  72 => 41,  68 => 39,  65 => 38,  48 => 23,  45 => 22,  24 => 3,  20 => 2,  17 => 1,);
    }
}
