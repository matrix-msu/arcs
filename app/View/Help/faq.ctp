...
<h4 id="what-is-a-resource">What is a resource?</h4>
<p>A resource is defined as a digital representation of a single physical piece in
...
further study. A resource can be part of any number of collections.</p>
<h4 id="how-do-i-make-a-collection">How do I make a collection?</h4>
<p>A collection is a group of resources meant to be studied together. You can
...
would want to remember and use it in some form in the future.</p>
<h4 id="what-happens-when-i-flag-something">What happens when I flag something?</h4>
<p>When you flag a resource, it opens an issue that requires the Senior
...
flag. In either case, they leave a comment with an explanation for the user.</p>
<h4 id="how-do-i-add-an-annotation">How do I add an annotation?</h4>
<p>A resource can be annotated on the Viewer page. You can add an annotation by
...
<h4 id="how-do-i-use-the-search-bar">How do I use the search bar?</h4>
<p>Searching works based on a concept called facets. Facets are essentially
...
as to what exactly you believe is wrong. </p>
<p>As a Senior Researcher, you have the same privileges of a Researcher, but you
have the added privilege of reviewing flags, and editing annotations, keywords,
resources and resource attributes. </p>
<h4 id="how-do-i-delete-my-account">How do I delete my account?</h4>
<p>Because your contributions in ARCS are so important to the success of the
...
made to the research project are not lost with your account.</p>