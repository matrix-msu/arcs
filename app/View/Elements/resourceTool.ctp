<ul id="resource-tools">
  ...
  <li class="resource-icons resource-icon-zoom-in-out">
    <div class="zoom-div">
      ...
      <img id="zoom-in" class="resources-zoom-in-icon" src="/<?php echo BASE_URL; ?>img/ZoomIn.svg">
    </div>
  </li>
  <li class="resource-icons"> <img class="resources-rotate-icon" src="/<?php echo BASE_URL; ?>img/Rotate.svg"> </li>
  <li class="resource-icons"><img id="next-resource"class="arrow-right-icon" src="/<?php echo BASE_URL; ?>img/ArrowRight.svg"></li>
</ul>
